...
public class VjmhdDiaryIndicator implements java.io.Serializable {
	...
	/** default constructor */
	public VjmhdDiaryIndicator() {
	}

	/** minimal constructor */
	public VjmhdDiaryIndicator(Long diaryId, Long id) {
		this.diaryId = diaryId;
		this.id = id;
	}

	/** full constructor */
	public VjmhdDiaryIndicator(Long diaryId, Long id, String uuid, Long userId,
