...
public class JmhdUserRecontact implements java.io.Serializable {
	...
	/** default constructor */
	public JmhdUserRecontact() {
	}

	/** minimal constructor */
	public JmhdUserRecontact(Long id) {
		this.id = id;
	}

	/** full constructor */
	public JmhdUserRecontact(Long id, Long userId, String empiid,
